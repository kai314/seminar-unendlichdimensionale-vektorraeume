...
%
    \begin{frame}{Beweis}
        ...
        \begin{flalign*}
            ...
            & \lim _{n \rightarrow \infty} y_n=0_V, ~ L 0_V=0_W \quad \text{für jede lineare Abbildung} \\ \pause
            & \text{gleichzeitig} \quad \|Ly_n\| \geq 1 \quad \forall n \in \mathbb{N} \\ \pause
            & \Rightarrow ~ L ~ \text{in} \quad 0_V ~ \text{unstetig}
        \end{flalign*}
    \end{frame}
%
    \begin{frame}{Beweis}
...
%
    \begin{frame}{Beispiel 1: Wohldefiniertheit}
        ...
        \begin{flalign*}
            ...
            & \text{sei} \quad x \in \ell^2 ~ \text{beliebig}, ~ \quad b=\left(b_n\right)_{n \in \mathbb{N}}, \quad b_n\coloneqq\frac{1}{n} \\ \pause
...
%
    \begin{frame}{Beispiel 1: Linearität}
        ...
        \begin{flalign*}
            ...
            & \hspace{20em} \forall a \in \ell^{2}, ~\lambda \in \mathbb{C} \pause
        \end{flalign*}
...
%
    \begin{frame}{Beispiel 2: Wohldefiniertheit}
        ...
        \begin{flalign*}
            ...
            & \text{sei} \quad x \in \ell^{\infty} \Rightarrow\left|\frac{x_n}{n}\right| \leq\left|x_n\right| \quad \forall n \in \mathbb{N} \\ \pause
...
%
    \begin{frame}{Beispiel 2: Linearität}
        ...
        \begin{flalign*}
            ...
            & \hspace{18em} \forall a \in \ell^{\infty}, ~\lambda \in \mathbb{C} \pause
        \end{flalign*}
...
%
    \begin{frame}{Beispiel 2: Stetigkeit}
        ...
        \begin{flalign*}
            ...
            & \|A x\|_{\infty}=\|x\|_{\infty} ~ \text{siehe oben} ~ \Rightarrow\|A x\|_{\infty} \leq 1 \quad \forall x \in \ell^{\infty}:\left\|x\right\|_{\infty} \leq 1 \\ \pause
...
%
    \begin{frame}{Beispiel 2: Stetigkeit der Umkehrabbildung}
        ...
        \begin{flalign*}
            ...
            & \Rightarrow\left\{A^{-1} y\|: y \in X,\| y \|_{\infty} \leq 1\right\}, ~ A ~ \text{ist unbeschränkt} \\ \pause
